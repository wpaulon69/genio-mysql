// Script para crear una página de prueba simple
const fs = require('fs');
...
fs.writeFileSync('src/app/test-schedule/page.tsx', simpleTestPage);
console.log('✅ Página de prueba creada en: src/app/test-schedule/page.tsx');
console.log('🔍 Visita: http://localhost:9002/test-schedule');