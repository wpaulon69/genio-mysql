...
-- =====================================================
-- PASO 1: CREAR TABLAS DE AUTENTICACIÓN (MySQL 5 Compatible)
-- =====================================================
...
-- Tabla de usuarios del sistema (MySQL 5 Compatible)
...
-- Tabla de sesiones para auditoría (MySQL 5 Compatible)
...
-- Crear usuario super administrador inicial (MySQL 5 Compatible)
...
-- =====================================================
-- NOTAS IMPORTANTES PARA MYSQL 5
-- =====================================================

/*
DIFERENCIAS CON MYSQL 8:
- BOOLEAN → TINYINT(1)
- UUID() → IDs manuales
- utf8mb4 → utf8
- Collation simplificada
